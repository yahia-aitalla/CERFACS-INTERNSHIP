...
<!-- Figure: Decaying turbulence (rollout vs. injection horizon) -->
<p align="center">
...
<!-- Figure: Forced turbulence (free rollout) -->
<p align="center">
  ...
  <a href="img/tke_rows_forced_free.png">
    <img src="img/tke_rows_forced_free.png" alt="Forced turbulence: TKE time series under free rollout for increasing training rollout length (Nut)" />
  </a>
  <br/>
  <em>
...
<!-- Curriculum learning — Decaying turbulence -->
<p align="center">
...
<!-- Curriculum learning — Forced turbulence -->
<p align="center">

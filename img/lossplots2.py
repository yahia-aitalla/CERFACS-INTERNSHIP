...
def make_losses_grid(
    ...
    pcurr: str | Path = "/scratch/algo/aitalla/StageGitlab/metrics_epoch.csv",
    out_path: str | Path = "losses_grid7.png",
    figsize=(12.0, 6.8),
) -> Path:
    apply_paper_style()
  ...
  # <-- si cette ligne provoque une erreur, remets fig.add_subplot
    ...
    title64  = r"Decaying turbulence — $64\times64$, $N_{\mathrm{ut}}=8$ (training loss)"
    title256 = r"Decaying turbulence — $256\times256$, $N_{\mathrm{ut}}=8$ (training loss)"
    ...
    color_title_fragment(
        ax64,
        whole_title_prefix="Decaying turbulence — ",

...
GRID_PATHS: List[List[Tuple[str, str]]] = [
    ...
    [
        ...
        ("1ut / 2",     "/scratch/algo/aitalla/StageGitlab/predictions/256deacying_1ut_2inject/preds/vorticity.h5"),
    ...
    [
        ...
        ("2ut / 2",     "/scratch/algo/aitalla/StageGitlab/predictions/256deacying_2ut_2inject/preds/vorticity.h5"),
    ...
    [
        ...
        ("4ut / 2",     "/scratch/algo/aitalla/StageGitlab/predictions/256deacying_4ut_2inject/preds/vorticity.h5"),
    ...
    [
        ...
        ("8ut / 2",     "/scratch/algo/aitalla/StageGitlab/predictions/256deacying_8ut_2inject/preds/vorticity.h5"),
    ...
    [
        ...
        ("Cur8 / 2",    "/scratch/algo/aitalla/StageGitlab/predictions/256_decaying_Curriculum_8ut_2inject/preds/vorticity.h5"),
...
def plot_grid_tke(real_h5: str, grid_paths: List[List[Tuple[str,str]]], out_path: str = "grid_tke.png"):
    ...
    fig.suptitle(r"Inference free-forecast horizon before truth injection ($H$)", y=0.975, fontsize=14) #y=0.985 11
...
if __name__ == "__main__":
    plot_grid_tke(REAL_H5, GRID_PATHS, out_path="final_grid_tke_256x256vorticity.png")
    #plot_grid_spectrum(REAL_H5, GRID_PATHS, out_path="grid_spectrum.png")
    print("Saved: final_grid_tke_256x256vorticity.png, grid_spectrum.png")
